...
class ChildrenCounter extends StatefulWidget {
  ...
  @override
  State<ChildrenCounter> createState() => _CustomizableCounterState();
}

class _CustomizableCounterState extends State<ChildrenCounter> {
  double mCount = 0;
